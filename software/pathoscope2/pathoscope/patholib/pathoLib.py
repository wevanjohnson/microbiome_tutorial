...
note:
'''
def append_ti_into_fasta_app(ncbiNt, taxon_ids, subTaxF, MySqlConf, enable_descF,
		enable_onlineF, outPrefix, outDir):
...
note:
'''
def get_allsub_taxons_phylo(h_tax_node2par,hiTaxons):
